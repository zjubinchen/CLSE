            ...
            for score_type in "${score_types[@]}"; do
                for l_list in "${l_lists[@]}"; do
                    for k_list in "${k_lists[@]}"; do
                        ...
                        current_output_dir="./results_3d/kp_${kp}_mt_${merge_tokens}_c${cutoff}_t${temp}_st_${score_type}_l${l_list}_k${k_list}_cm${use_cluster_merge}/TGIF_Zero_Shot_QA/${CKPT_NAME}"
