...
class Qwen2VLTextModel(Qwen2VLPreTrainedModel):
    ...
    def __init__(self, config: Qwen2VLTextConfig):
        ...
        self.pruning_ratios = [0.334]  # fraction of visual tokens to retain at each pruning stage

        assert len(self.K_list) == len(self.pruning_ratios), \
            "K_list and pruning_ratios must have the same length"
        ...
        **kwargs,
        ...
        for layer_idx, decoder_layer in enumerate(self.layers):
            ...
            if self.prune and layer_idx in self.K_list and has_visual and self.last_attention is not None:
                ...
                target_keep = max(1, int(original_visual_len * self.pruning_ratios[k_idx]))
                ...
                if current_len > target_keep:
                    ...
                    evolution_score = calculate_evolution_score(
                        ...
                        cutoff=self.cutoff, temp=self.temp, score_type=self.score_type
                    )
